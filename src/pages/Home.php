  ...
  <div class="px-8 py-12">
    ...
    <div class="grid gap-8">
      ...
      <div class="grid gap-8 grid-cols-3 px-14">
        <div
          class="flex kategory gap-8 items-center p-4 border-2 drop-shadow-sm w-full roun rounded-xl hover:bg-blue-50 hover:scale-[101%]">
          <img class="h-10" src="../../icon/Kategory/carbon_vehicle-services.png" alt="" />
          <h1 class="text-2xl font-medium">Bengkel</h1>
        </div>

        <div
          class="flex gap-8 kategory items-center p-4 border-2 drop-shadow-sm w-full rounded-xl hover:bg-blue-50 hover:scale-[101%]">
          <img class="h-10" src="../../icon/Kategory/carbon_vehicle-services.png" alt="" />
          <h1 class="text-2xl font-medium">Bengkel</h1>
        </div>
